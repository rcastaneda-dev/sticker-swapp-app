...
const (
	...
	deviceCompromisedCtxKey contextKey = "deviceCompromised"
)
...
// DeviceCompromisedKey returns the context key for the device integrity flag.
func DeviceCompromisedKey() contextKey { return deviceCompromisedCtxKey }
